...
public class Car {
	...
	/*
	 * Use contrl+space+enter button to create method ex:driveCar is the method
	 * name. To create a method, type the method name, then press ctrl+space+enter
	 * button Rename the access modifier from private to public
	 */
